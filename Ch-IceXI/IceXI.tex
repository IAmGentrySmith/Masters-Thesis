...
Essentially, water's tetrahedral structure allows for four interactions on each molecule. 
...
Ice I$_{h}$ naturally forms in pure solution at temperatures in the 72 K to 273.15 K range at at pressures in the 1 Pa to 100 MPa range, with some temperature curving off into the vapour and liquid phases at very high and very low pressures.
...
He additionally predicted that a ice may exist at sufficiently low temperatures with zero entropy.
%P/T deets
...
The most commonly cited effort to create an ice I$_{h}$ crystal comes from \cite{MCIce}. 
