...
Once these closest neighboring oxygen atoms have been discovered, the appropriate tetrahedral position is identified and marked 
...
The first step, discovering the defects, relies on the detection
