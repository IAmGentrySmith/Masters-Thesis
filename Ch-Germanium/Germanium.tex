...
Effectively the cis and trans angles coincide with gauche and anti-periplanar in organic structure nomenclature % WORDSWORDWORDS, 
...
\begin{table}[]
	\centering
	\begin{tabular}{lllll}
		Program & \begin{tabular}[c]{@{}l@{}}Trans Energy\\ (Hartree)\end{tabular} & \begin{tabular}[c]{@{}l@{}}Cis Energy\\ (Hartree)\end{tabular} & \begin{tabular}[c]{@{}l@{}}$\Delta$ Energy\\ trans - cis\\ (Hartree)\end{tabular} & \begin{tabular}[c]{@{}l@{}}$\Delta$ Energy\\ trans - cis\\ (kJ / mol)\end{tabular} \\ \hline
